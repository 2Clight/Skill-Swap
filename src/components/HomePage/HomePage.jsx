          ...
          <Card className="bg-gray-800 shadow-lg">
            <CardContent className="flex flex-col md:flex-row items-center gap-6 p-6">
              <div className="flex-1 text-left">
                <h2 className="text-2xl font-semibold text-teal-400">Welcome back, {userData.name}!</h2>
                <div className="mt-4">
                  <h3 className="text-xl font-medium">Your Skills</h3>
                  <p className="text-gray-300">{userData.possessedSkills?.join(", ") || "Not specified"}</p>
                </div>
                <div className="mt-4">
                  <h3 className="text-xl font-medium">Skills You Want to Learn</h3>
                  <p className="text-gray-300">{userData.skillsToLearn?.join(", ") || "Not specified"}</p>
                </div>
              ...
              <Button variant="outline" className="border-teal-400 text-teal-400 hover:bg-teal-500 hover:text-white">Edit Profile</Button>
            </CardContent>
          </Card>
        </section>
      )}
